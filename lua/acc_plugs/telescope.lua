...
vim.cmd(
  [[noremap <leader>ps :lua require('telescope.builtin').live_grep({ path_display = "shorten", only_sort_text = true })<CR>]]
)
vim.cmd([[nnoremap <C-p> :lua require('telescope.builtin').find_files({})<CR>]])
vim.cmd([[nnoremap <Leader>fs :lua require('telescope.builtin').find_files({})<CR>]])
...
vim.cmd(
  [[nnoremap <leader>fw :lua require('telescope.builtin').grep_string({ only_sort_text = true, search = '' })<CR>]]
)
vim.cmd([[nnoremap <leader>pb :lua require('telescope.builtin').buffers()<CR>]])
vim.cmd(
  [[nnoremap <leader>t :lua require('telescope.builtin').tags({path_display = "shorten", only_sort_text = true})<CR>]]
)
