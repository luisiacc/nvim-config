...
nnoremap <leader>pw :lua require('telescope.builtin').live_grep({ shorten_path = true, search = vim.fn.expand("<cword>") })<CR>
...
nnoremap <leader>t :lua require('telescope.builtin').tags{shorten_path = true, only_sort_text = true}<CR>
