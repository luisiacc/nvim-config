...
nnoremap <leader>fw :lua require('telescope.builtin').grep_string(require('telescope.themes').get_ivy{ shorten_path = true, search = vim.fn.input("Grep For > ")})<CR>
noremap <leader>ps :lua require('telescope.builtin').live_grep(require('telescope.themes').get_ivy{ shorten_path = true, only_sort_text = true })<CR>
...
nnoremap <leader>pw :lua require('telescope.builtin').live_grep(require('telescope.themes').get_ivy{ shorten_path = true, search = vim.fn.expand("<cword>") })<CR>
